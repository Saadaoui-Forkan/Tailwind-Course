...
function Colors() {
  return (
    <>
      ...
      {/* Accent Colors  */}
      <input type="checkbox" className="accent-purple-500"  /> Option 1
      <input type="checkbox" className="accent-pink-500"  /> Option 2
      <input type="checkbox" className="accent-red-300"  /> Option 3
      {/* Arbitrary Colors  */}
